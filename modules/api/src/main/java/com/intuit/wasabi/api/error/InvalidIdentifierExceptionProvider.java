...
@Provider
public class InvalidIdentifierExceptionProvider extends ExceptionProvider<InvalidIdentifierException> {

    @Inject
    public InvalidIdentifierExceptionProvider(final HttpHeader httpHeader, final ExceptionJsonifier exceptionJsonifier) {
