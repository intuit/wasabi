...
public class NoOpAuthenticateByHttpRequestImplTest {
    ...
    public void authenticateTest() {
        ...
        AuthenticateByHttpRequest authenticateByHttpRequest =
                new NoOpAuthenticateByHttpRequestImpl();
        Object infoFromAuthMap = authenticateByHttpRequest.authenticate(httpRequestContextMock);
        assertNull(infoFromAuthMap);
    }
}
