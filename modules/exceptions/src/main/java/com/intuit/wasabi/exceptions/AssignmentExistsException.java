...
import static com.intuit.wasabi.experimentobjects.exceptions.ErrorCode.ASSIGNMENT_EXISTS_VIOLATION;
...
public class AssignmentExistsException extends WasabiClientException {
    ...
    public AssignmentExistsException(String userID, Application.Name applicationName,
                                     Experiment.Label experimentLabel) {
        this(userID, applicationName, experimentLabel, null);
    }

    public AssignmentExistsException(String userID, Application.Name applicationName, Experiment.Label experimentLabel,
                                     Throwable rootCause) {
        super(ASSIGNMENT_EXISTS_VIOLATION, "Assignment for userID \"" + userID + "\", applicationLabel \"" +
