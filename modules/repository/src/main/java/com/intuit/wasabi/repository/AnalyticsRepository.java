...
public interface AnalyticsRepository {
    ...
    /**
     * Get the date of the most recent rollup.  Check to make sure that the toTime is specified and last rollup.
     * Return <code>true</code> if the date of the most recent rollup is before the specified toTime.
     *
