...
public class CassandraAssignmentsRepositoryTest {
    ...
    private CassandraAssignmentsRepository cassandraAssignmentsRepository;

    @Before
    public void setup() throws IOException, ConnectionException {
        cassandraAssignmentsRepository = new CassandraAssignmentsRepository(
    ...
    @Test
    public void testGetUserAssignmentPartitionsEqual() {
        Date from_time = new Date();
    ...
    @Test
    public void testGetUserAssignmentPartitionsFromGreaterTo() {
        Date from_time = new Date();
