...
class DestinationSparkCassandraRepository(sc: SparkContext, options: DataStoreConnectionProperties, connection: CassandraConnector, sqlContext: CassandraSQLContext, currentTimestampFunc: CurrentTimestampFunc) extends SparkCassandraRepository(sc, options, connection, sqlContext, currentTimestampFunc) {
  @Inject
