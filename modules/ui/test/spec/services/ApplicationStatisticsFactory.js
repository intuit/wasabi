...
describe('ApplicationStatisticsFactory', function () {
    ...
    beforeEach (function () {
        angular.mock.inject(function($injector){
            ...
            mockFactory = $injector.get('ApplicationStatisticsFactory');
        });
    ...
    describe('#query', function () {
        ...
        it('makes requests', function () {
            ...
            $httpBackend.whenGET(Cfg.baseUrl() + '/analytics/experiments/assignments/counts').respond(errorResponse);
