...
describe('ExperimentStatisticsFactory', function () {
    ...
    beforeEach (function () {
        angular.mock.inject(function($injector){
            ...
            mockFactory = $injector.get('ExperimentStatisticsFactory');
        });
    ...
    describe('#query', function () {
        ...
        it('makes requests', function () {
            ...
            $httpBackend.whenGET(Cfg.baseUrl() + '/analytics/experiments/statistics').respond(errorResponse);
    ...
    describe('#dailies', function () {
        ...
        it('makes requests', function () {
            ...
            $httpBackend.expectGET('views/SignIn.html');
            $httpBackend.whenGET('views/SignIn.html').respond(html);
            $httpBackend.whenGET(Cfg.baseUrl() + '/analytics/experiments/statistics/dailies').respond(errorResponse);
            
            var result = mockFactory.dailies();
            $httpBackend.flush();
