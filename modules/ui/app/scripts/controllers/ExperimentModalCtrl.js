                ...
                $scope.startExperiment = function(isFormInvalid) {
                    ...
                    $scope.validateBuckets(true, $scope.experiment.id, function() {
                        ...
                        $scope.changeState($scope.experiment, 'RUNNING', function() {
                            DialogsFactory.alertDialog('Your experiment has been started successfully!  PLEASE NOTE: The experiment may not be available for batch assignments for up to 5 minutes.', 'Start Successful');
