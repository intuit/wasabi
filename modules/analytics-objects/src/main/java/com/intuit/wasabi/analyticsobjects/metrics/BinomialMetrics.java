...
public enum BinomialMetrics {
    ...
    public BinomialMetric constructMetric(final double conf_level) {
        ...
        try {
            return binomialMetricClass.getConstructor(parameters).newInstance(conf_level);
    ...
    public BinomialMetric constructMetric(final double conf_level,
        ...
        try {
            return binomialMetricClass.getConstructor(parameters).newInstance(conf_level, max_decisions);
        } catch (InvocationTargetException e) {
            if (e.getCause() instanceof RuntimeException) {
                throw (RuntimeException) e.getCause();
            } else {
