...
###############################################################################
#!/usr/bin/env bash
# Script to run the Java/TestNG based Smoke tests for Wasabi
#
# Relying on
...
archivedir=smoke-test-archive                        # To collect files for Jenkins to archive
mkdir -p $archivedir
...
outputdir=$archivedir/smoke-testng-out
testngxml=classes/testng_smokeTest.xml
