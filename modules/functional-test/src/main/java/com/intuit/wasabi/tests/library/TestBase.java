...
public class TestBase extends ServiceTestBase {
	...
	/**
	 * Sends a PUT request to update the list of experiments.
	 * The response must contain {@link HttpStatus#SC_OK}.
	 * <p>
	 * Excludes the experiments creation and modification times.
	 * <p>
	 * If this call was used to delete an experiment (by changing the state to DELETED) it will return a new, empty
	 * experiment.
	 *
	 * @param experimentList the list of experiments to PUT
	 * @return the new list of changed experiments
	 */
	public List<Experiment> putExperimentList(List<Experiment> experimentsList) {
		List<Experiment> experimentList = new ArrayList<Experiment>();
		for(Experiment experiment: experimentList)
		{
			Experiment exp = putExperiment(experiment, HttpStatus.SC_OK);
	...
	public List<String>  getUserApplications(APIUser user, int expectedStatus, APIServerConnector apiServerConnector) {
		//changing the password to the credentials of the user
