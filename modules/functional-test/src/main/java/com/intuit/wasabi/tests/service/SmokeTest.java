...
public class SmokeTest extends TestBase {
    ...
    public void retrieveExperiment() {
     ...
     */
    @Test(dependsOnMethods = {"retrieveExperiment"}, retryAnalyzer = RetryAnalyzer.class)
     ...
     */
    @Test(dependsOnMethods = {"deleteLastBucket"})
     ...
     */
    @Test(dependsOnMethods = {"createNewBucket"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 2000)
    public void retrieveBuckets() {
     ...
     */
    @Test(dependsOnMethods = {"createNewBucket"})
     ...
     */
    @Test(dependsOnMethods = {"assignUsersToBuckets"})
    public void changeSpecialUsersAssignment() {
     ...
     */
    @Test(dependsOnMethods = {"changeSpecialUsersAssignment"})
     ...
     */
    @Test(dependsOnMethods = {"changeSpecialUsersAssignment"})
    public void getUserAssignmentsAcrossExperiments() {
     ...
     */
    @Test(dependsOnMethods = {"setUserAssignments"})
     ...
     */
    @Test(dependsOnMethods = {"submitEvents"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 2000)
    ...
    /**
     * Asserts the daily summaries. The same as dailySummaryOfDerivedStatistics, but for another endpoint.
     */
    @Test(dependsOnMethods = {"submitEvents"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 2000)
    ...
    @Test(dependsOnMethods = {"submitEvents"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 2000)
    public void summaryWithDerivedStatistics() {
    ...
    /**
     * Asserts the daily summaries. The same as dailySummary, but for another endpoint.
     */
    @Test(dependsOnMethods = {"submitEvents"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 2000)
    public void dailySummaryOfDerivedStatistics() {
        ExperimentCumulativeStatistics dailies = getDailyStatistics(experiment);
     ...
     * closes the buckets
     */
    @Test(dependsOnMethods = {"dailySummary", "retrieveEvents", "summaryWithDerivedStatistics", "dailySummaryOfDerivedStatistics"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(warmup = 2000, maxTries = 3)
     ...
     * empties one bucket
     */
    @Test(dependsOnMethods = {"closeBuckets"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(warmup = 2000, maxTries = 3)
     ...
     */
    @Test(dependsOnMethods = {"createExperiments"})
    public void excludeAnotherExperiment() {
     ...
     */
    @Test(dependsOnMethods = {"excludeAnotherExperiment"}, retryAnalyzer = RetryAnalyzer.class)
    @RetryTest(maxTries = 3, warmup = 500)
    public void checkExclusions() {
     ...
     */
    @Test(dependsOnMethods = {"checkExclusions"})
     ...
     * Retrieve the exclusions and check if it worked.
     */
    @Test(dependsOnMethods = {"deleteExclusions"})
    public void checkExclusionsAfterDeletion() {
        List<Experiment> experiments = getExclusions(mutualExclusiveExperiment);
     ...
     */
    @Test(dependsOnMethods = {"assignUsersToBuckets"})
    public void prioritizeExperiment() {
     ...
     */
    @Test(dependsOnMethods = {"assignUsersToBuckets"})
    public void retrieveExperimentAssignments() {
     ...
     */
    @Test(dependsOnMethods = {"submitPages"})
    public void getPages() {
        List<Page> retrievedPages = getPages(experiment);
        assertEqualModelItemsNoOrder(retrievedPages, pages);
    }

    @Test(dependsOnMethods = {"getPages", "retrieveExperimentAssignments", "emptyBucket"})
    public void pauseExperiments() {
     ...
     */
    @Test(dependsOnMethods = {"pauseExperiments"})
    public void terminateExperiments() {
     ...
     * Deletes experiments.
     */
    @Test(dependsOnMethods = {"terminateExperiments"})
    public void deleteTestExperiments() {
     ...
     */
    @Test(dependsOnMethods = {"deleteTestExperiments"})
    public void checkDeletedExperiments() {
     ...
     */
    @Test(dependsOnMethods = {"checkDeletedExperiments"})
