...
public class BasicPriorityTest extends TestBase {
    ...
    public void priorityChange(String appName) {
    ...
    @Test(groups = {"priorityChange"}, dependsOnMethods = {"priorityChange"}, dependsOnGroups = {"setup"},
    ...
    public void priorityListChange(String appName) {
    ...
    public void differentApplication(String experiment) {
        response = apiServerConnector.doPost("experiments", experiment);
        LOGGER.debug(response.jsonPath().prettify());
        Experiment result = ExperimentFactory.createFromJSONString(response.jsonPath().prettify());
    ...
    public void terminatedExperiment(String terminated, String redBucket, String blueBucket) {
    ...
    public void deletedExperiment(String deleted) {
