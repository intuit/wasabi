...
public class CountIntegrationTest extends TestBase {
    ...
    @RetryTest(maxTries = 3, warmup = 250)
    public void t_CheckPostAssignments() {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put(FROM_TIME, "");
        List<Event> events = postEvents(experiment,
                parameters, true,
    ...
    @Test(dependsOnMethods = {"t_CheckPostAssignments"})
    ...
    @RetryTest(maxTries = 3, warmup = 250)
    public void t_CheckPostImpressions() {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put(FROM_TIME, "");
        List<Event> events = postEvents(experiment,
                parameters, true,
    ...
    @Test(dependsOnMethods = {"t_CheckPostImpressions"})
    public void t_PostClick() {
        ...
        for (User user : users) {
            ...
            postEvent(event, experiment, user, HttpStatus.SC_CREATED);
        }
    }

    @Test(dependsOnMethods = {"t_PostClick"})
    @RetryTest(maxTries = 3, warmup = 250)
    public void t_CheckPostClick() {
        Map<String, Object> parameters = new HashMap<>();
    ...
    @Test(dependsOnMethods = {"t_CheckPostClick"})
    public void t_PostClickTomorrowPlus2() {
        User[] users = {userBill, userJane};
        for (User user : users) {
            Event event = EventFactory.createEvent();
            event.context = QBO;
    ...
    @Test(dependsOnMethods = {"t_PostClickTomorrowPlus2"})
    @RetryTest(maxTries = 3, warmup = 250)
    public void t_CheckPostClickTomorrowPlus2() {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put(FROM_TIME, today);
        List<Event> events = postEvents(experiment,
                parameters, true,
    ...
    @Test(dependsOnMethods = {"t_CheckPostClickTomorrowPlus2"})
    ...
    @Test(dependsOnMethods = {"t_CheckPostLoveIt"})
    @RetryTest(maxTries = 3, warmup = 250)
    ...
    public void t_CheckAllEventsYesterdayOnwards() {
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsYesterdayOnwards"})
    public void t_CheckClickEventsYesterdayOnwards() {
        List<String> types = new ArrayList<String>();
        types.add(actionClick);
        AnalyticsParameters params = new AnalyticsParameters();
        params.confidenceLevel = .9999999d;
    ...
    @Test(dependsOnMethods = {"t_CheckClickEventsYesterdayOnwards"})
    public void t_CheckLoveItEventsYesterdayOnwards() {
        List<String> types = new ArrayList<String>();
        types.add(actionLoveIt);
        AnalyticsParameters params = new AnalyticsParameters();
        params.confidenceLevel = .9999999d;
    ...
    @Test(dependsOnMethods = {"t_CheckLoveItEventsYesterdayOnwards"})
    public void t_CheckAllEventsYesterdayOnwardsOnlyImpressions() {
        List<String> types = new ArrayList<String>();
        types.add(actionImpression);
        AnalyticsParameters params = new AnalyticsParameters();
        params.confidenceLevel = .9999999d;
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsYesterdayOnwardsOnlyImpressions"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsYesterdayOnly"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsTodayOnly"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsTomorrowOnly"})
    public void t_CheckAllEventsYesterdayOnly2() {
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsYesterdayOnly2"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsTodayOnWards"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventsTomorrowOnWards"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromYesterday"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromToday"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromYesterdayMinus3"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventToTomorrowPLus3"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromYesterdayMinus3ToTomorrowPLus3"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromTomorrow"})
    ...
    @Test(dependsOnMethods = {"t_CheckAllEventFromYesterdayAndToday"})
    ...
    @Test(dependsOnMethods = {"t_CheckAssignmentsCount"})
